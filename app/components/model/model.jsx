...
export const Model = ({
  ...
  useEffect(() => {
    ...
    const keyLight = new DirectionalLight(0x404040, 100);
    const fillLight = new DirectionalLight(0x404040, 100);
...
const Device = ({
  ...
  let loadFullResTexture = async () => {}; // Default no-op function
  let playAnimation = () => {}; // Also add default for playAnimation
  ...
  gltf.scene.traverse(async node => {
    ...
    if (node.name === MeshType.Screen) {
      // Create a copy of the screen mesh...
